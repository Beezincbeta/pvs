...
define('BOT_TOKEN', '231117825:AAGFuQHvZv4RSHih-7aNyStrpuWQPcdxWyY');
...
یا اگر نیاز به راهنمایی بیشتر داریددستور زیر را ارسال کنید

/help

کانال ما  👈        [PayamResanSazRoBot](https://telegram.me/PayamResansaz_ch)

🔹هر نفر = یک ربات ✖️
🔸ربات دوم = 5000ت ✔️
🤖 @PayamResanSazRoBot',"parse_mode"=>"MARKDOWN","disable_web_page_preview"=>"true"));
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pmresan-resanmmm.rhcloud.com//'.$chat_id.'/pvresan.php');
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://pmresan-resanmmm.rhcloud.com//'.$chat_id.'/pvresan.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot231117825:AAGFuQHvZv4RSHih-7aNyStrpuWQPcdxWyY/";
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://pmresan-resanmmm.rhcloud.com//'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=PayamResanSazRoBot
