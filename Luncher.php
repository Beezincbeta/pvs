...
define('BOT_TOKEN', '261383190:AAGQOi4TrXoo3CgbbjCafykEVv0Vswva9rc');
...
";
      ...
      apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "<b>PvSazRoBot</b>
<b>ver. 1.0</b>
<code>Coded By</code> @NobLest
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pvsaaz-mohamad00.rhcloud.com/Launcher.php'.$chat_id.'/pvresan.php');
apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "🚀 ربات شما با مـوفقیت آپدیت شد ♻️"));


    }
    }
    else if ($matches[0] != "/update"&& $matches[1]==""&&$chat_id != 140671364) {
      if (strpos($text, ":")) {
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://pvsaaz-mohamad00.rhcloud.com.rhcloud.com/Launcher.php'.$chat_id.'/pvresan.php');
...
.";
    ...
    $bot_url    = "https://api.telegram.org/bot261383190:AAGQOi4TrXoo3CgbbjCafykEVv0Vswva9rc/"; 
...
🚀 @NobLest"));
        ...
        }else if ($matches[0] != "/update"&&$matches[1] != ""&&$matches[2] != ""&&$chat_id == 140671364) {
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://pvsaaz-mohamad00.rhcloud.com/Launcher.php'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
";
